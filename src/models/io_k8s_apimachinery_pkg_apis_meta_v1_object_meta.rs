...
pub struct IoK8sApimachineryPkgApisMetaV1ObjectMeta {
    ...
    #[serde_diff(skip)]
    pub finalizers: Option<Box<Vec<String>>>,
    ...
    #[serde_diff(skip)]
    pub managed_fields: Option<Box<Vec<models::IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry>>>,
    ...
    #[serde_diff(opaque)]
    pub owner_references: Option<Box<Vec<models::IoK8sApimachineryPkgApisMetaV1OwnerReference>>>,
